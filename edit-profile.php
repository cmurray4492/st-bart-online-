<?php
$page_title = "St Bartholomew AFF - Edit Profile";
        ...
        <?php else: ?>
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fullname" value="<?php if(isset($fullname)) echo $fullname; ?>" class="form-control" id="usernameField">
                    </div>
                    <div class="form-group">
                        <label for="phoneField">Phone</label>
                        <input type="text" name="phone" value="<?php if(isset($phone)) echo $phone; ?>" class="form-control" id="usernameField">
                    </div>
                    <!-- 
                    <div class="form-group">
