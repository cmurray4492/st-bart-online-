    ...
    if(isset($response->success) && !$response->success == true){
        ...
        //check if error array is empty, if yes process form data and insert record
            ...
            try{
                ...
                $sqlInsert = "INSERT INTO users (username, email, password, fullname, phone, join_date)
              VALUES (:username, :email, :password, :fullname, :phone, now())";
                ...
                ':password' => $hashed_password, ':fullname' => $fullname, ':phone' => $phone));
                ...
                if($statement->rowCount() == 1){
                    ...
                    <body style="background-color:#CCCCCC; color:#000; font-family: Arial, Helvetica, sans-serif;
                                        line-height:1.8em;">
                    <h2>Saint Bartholomew Adult Faith Formation</h2>
                    <p>Dear '.$username.'<br><br>Thank you for registering, please click on the link below to
                        confirm your email address</p>
                    <p><a href="http://st-bart.online/activate.php?id='.$encode_id.'"> Confirm Email</a></p>
                    <p><strong>&copy;2019 Saint Bartholomew Adult Faith Formation</strong></p>
                    </body>
                    </html>';

                    $mail->addAddress($email, $username);
                    $mail->Subject = "Message from St Bart's Adult Faith Formation";
                    $mail->Body = $mail_body;
...
//activation
    ...
    if ($statement->rowCount() == 1) {
        $result = '<h2>Email Confirmed - Discovering Christ</h2>
        <p>Your email address has been verified. <!-- , you can now 
        <a href="login.php">login</a> with your email and password. --> </p>
        <p>This is another palce wehre we could include more information 
        about the date and time of the program.</p>
        ';
    } else {
