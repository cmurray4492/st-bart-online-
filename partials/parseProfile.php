        ...
        if(validate_token($_POST['token'])){
            ...
            if(empty($form_errors) && !$result){
                try{
                    ...
                    fullname =:fullname, phone = :phone, avatar = :avatar WHERE id =:id";
                    ...
                    if($avatar != null) {
                        //create SQL update statement
                        $sqlUpdate = "UPDATE users SET username =:username, email =:email, fullname =:fullname, 
