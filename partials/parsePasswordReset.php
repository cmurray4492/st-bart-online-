...
if(isset($_POST['passwordResetBtn'], $_POST['token'])){
    ...
    if(validate_token($_POST['token'])){
        ...
        if(empty($form_errors)){
            ...
            $reset_token = htmlspecialchars($_POST['reset_token']);
            $password1 = htmlspecialchars($_POST['new_password']);
                ...
                if($rs = $statement->fetch()){
                    ...
                    $mail_body = '<html>
                        <body style="background-color:#CCCCCC; color:#000; font-family: Arial, Helvetica, sans-serif;
                                            line-height:1.8em;">
                        <h2>Adult Faith Formation - Saint bartholomew Katy TX</h2>
                        ...
                        <p><a href="http://st-bart.online/forgot_password.php"> Reset Password</a></p>
                        <p><strong>&copy;'.date('Y').' Saint Bartholomew Adult Faith Formation</strong></p>
                        </body>
                        </html>';

                    $mail->addAddress($email, $username);
                    $mail->Subject = "Password Recovery Message from St Bart's AFF";
                    $mail->Body = $mail_body;
