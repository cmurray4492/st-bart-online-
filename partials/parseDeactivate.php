                ...
                if ($deactivateQuery->rowCount() === 1){
                    ...
                    if ($insertRecord->rowCount() === 1){
                        ...
                        <body style="background-color:#CCCCCC; color:#000; font-family: Arial, 
                            ...
                            <p><a href="http://st-bart.online/login.php">Sign In</a></p>
                            <p><strong>&copy;2019 Saint Bartholomew Catholic Church</strong></p>
                        </body>
                        </html>';

                        $mail->addAddress($email, $username);
                        $mail->Subject = "Message from Saint Bartholomew AFF: Account Deactivated";
                        $mail->Body = $mail_body;
